 ...
 */
export function hullForEntity(ent, mins, maxs, out_offset) {
 ...
 */
export function createAreaNode(depth, mins, maxs) {
  ...
  anode.children = [
    createAreaNode(depth + 1, mins2, maxs),
    createAreaNode(depth + 1, mins, maxs1),
  ];
 ...
 */
export function unlinkEdict(ent) {
  if (ent.area.prev) {
 ...
 */
export function touchLinks(ent, node) {
 ...
 */
export function findTouchedLeafs(ent, node) {
 ...
 */
export function linkEdict(ent, touchTriggers = false) {
  ...
  if (ent.entity.modelindex !== 0) {
    findTouchedLeafs(ent, SV.server.worldmodel.nodes[0]);
  }
